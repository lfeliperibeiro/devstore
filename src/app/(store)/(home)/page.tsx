...
async function geFeaturedProducts(): Promise<Product[]> {
...
export default async function Home() {
  const [highlightedProducts, ...otherProducts] = await geFeaturedProducts();
  ...
  return (
    <div className="grid max-h-[860px] grid-cols-9 grid-rows-6 gap-6">
      ...
      >
        ...
        />
        <div className="absolute bottom-28 right-28 flex items-center gap-2 max-w-[280px] rounded-full border-2 border-zinc-50 bg-black/60 p-1 pl-5">
        ...
        return (
          ...
          >
            <Image
              ...
              className="group-hover:scale-105 transition-transform duration-500"
            />
            <div className="absolute bottom-10 right-10 flex items-center gap-2 max-w-[280px] rounded-full border-2 border-zinc-50 bg-black/60 p-1 pl-5">
